...
const EbenezerDrivingPage = () => {
  ...
  const [loading, setLoading] = useState(false);
   ...
   if (isLoading) {
     return <Loading loadimg={EbenerzerDS} />;
   }
    ...
    <>
      <nav className="border-gray-200 bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={EbenerzerDS} className="h-auto w-36" alt="SKYLAS Logo" />
          </a>
          <button
            onClick={toggleMenu}
            type="button"
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className=":bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-white text-3xl md:text-5xl font-extrabold mb-2">
              Book your next lesson with Ebeneezar Driving School
            </h1>
            <p className="text-lg font-normal text-gray-400 mb-6">
              Ebeneezar Driving School is a trusted provider of driving
              education, emphasizing safe driving practices and skill
              development. With experienced instructors, they offer
              comprehensive courses tailored to learners of all levels.
              Ebeneezar Driving School prioritizes fostering confidence and
              responsible driving habits among its students.
            </p>
          </div>
        </div>
      </section>
      <div className="bg-gray-900">
        <div className="bg-gray-900 py-10">
          <div className="flex flex-col items-center px-6 mx-auto">
            ...
            >
              <img className="w-40 h-auto mr-2" src={EbenerzerDS} alt="logo" />
            </a>
      ...
      <footer className=" bg-gray-900">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            >
              <img src={EbenerzerDS} className="w-32 h-auto" alt="msdsa Logo" />
            </a>
...
export default EbenezerDrivingPage;
