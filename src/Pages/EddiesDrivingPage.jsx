        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className=":bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-white text-3xl md:text-5xl font-extrabold mb-2">
              Book your next lesson with Eddies Driving school
            </h1>
            <p className="text-lg font-normal text-gray-400 mb-6">
              Eddie's Driving School is a well-established institution known for
              its comprehensive driving instruction services. With a focus on
              safety and skill development, the school offers tailored courses
              for learners of all levels. Their experienced instructors provide
              personalized guidance to ensure students become confident and
