import QDS from "../assets/img/qs ds.webp";
...
const QDrivingPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Q's Driving School-Book Your Lessons</title>
        <meta
          name="description"
          content="Book driving lessons with Q's Driving School in Mitchells Plain. Safe and confident driving with experienced instructors."
        />
        <meta
          name="keywords"
          content="driving lessons, Q's Driving School, Mitchells Plain, driving instructor, learner driver"
        />
        <meta name="author" content="Q's Driving School" />
        <link rel="canonical" href="https://mpdsa.online/QDrivingSchool" />
      </Helmet>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className=":bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-white text-3xl md:text-5xl font-extrabold mb-2">
              Book your next lesson with Q's Driving School
            </h1>
            <p className="text-lg font-normal text-gray-400 mb-6">
              Q's Driving School is a reputable institution offering
              professional driving instruction services. With experienced
              instructors and a focus on safety, the school aims to equip
              students with the necessary skills and knowledge to become
              confident drivers. Offering a range of courses tailored to various
              skill levels, Q's Driving School prioritizes personalized learning
