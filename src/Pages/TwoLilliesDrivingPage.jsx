...
const TwoLilliesDrivingPage = () => {
 ...
 if (isLoading) {
  ...
  return (
    <>
      <Helmet>
        <title>Two Lillies Driving School-Book Your Lessons</title>
        <meta
          name="description"
          content="Book driving lessons with Two Lillies Driving School in Mitchells Plain. Safe and confident driving with experienced instructors."
        />
        <meta
          name="keywords"
          content="driving lessons, Two Lillies Driving School, Mitchells Plain, driving instructor, learner driver"
        />
        <meta name="author" content="Two Lillies Driving School" />
        <link
          rel="canonical"
          href="https://mpdsa.online/TwoliliesDrivingSchool"
        />
      </Helmet>
      ...
      <nav className="border-gray-200 bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={QDS} className="h-auto w-36" alt="SKYLAS Logo" />
          </a>
          <button
            onClick={toggleMenu}
            type="button"
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className=":bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <h1 className="text-white text-3xl md:text-5xl font-extrabold mb-2">
              Book your next lesson with Two Lillies Driving school
            </h1>
            <p className="text-lg font-normal text-gray-400 mb-6">
              Two Lillies Driving School is a well-established institution
              renowned for its quality driving instruction services. With a
              focus on both theoretical knowledge and practical skills, the
              school aims to produce confident and responsible drivers. Their
              experienced instructors and flexible course options cater to
              learners of all levels, ensuring students receive comprehensive
      ...
      <div className="bg-gray-900">
        <div className="bg-gray-900 py-10">
          <div className="flex flex-col items-center px-6 mx-auto">
            ...
            >
              <img className="w-40 h-auto mr-2" src={QDS} alt="logo" />
            </a>
      ...
      <footer className=" bg-gray-900">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            >
              <img src={QDS} className="w-32 h-auto" alt="msdsa Logo" />
            </a>
...
export default TwoLilliesDrivingPage;
